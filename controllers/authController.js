...
const register = async (req, res) => {
  ...
  // send verification token back only while testing the postman
...
const login = async (req, res) => {
  ...
  if (!user.isVerified) {
    throw new CustomError.UnauthenticatedError("User is not verified yet");
  }
  const tokenUser = createTokenUser(user);
  ...
  //create refreshToken because non-exist Token
...
const verifyEmail = async (req, res) => {
  ...
  if (!user) {
    throw new CustomError.UnauthenticatedError("There is no user");
  }
